...
urlpatterns = [
    ...
    path('<int:id_proyecto>/administrar_usuarios/', views.administrar_usuarios, name='administrar_usuarios'),
    ...
    path('<int:id_usuario>/desasignar_usuarios/', views.desasignar_usuarios, name='desasignar_usuarios'),
